...
| 4. 用户 Funnel 与结果展示 | 已完成 | 可完成测评到会员解锁 | 中文前端、刷新恢复、BMI 预览、保持体重分流提示页、目标体重建议、重要日期选择、日期来源选择、BMI 区间条、免费/会员结果、重开测评、非线性预测趋势展示 |
...
| 测试与质量 | 已完成 | `npm test` 本地通过：Vitest 63 个测试、Playwright 4 条 E2E |
...
| 2026-09-22 | 一键测试 | `npm test` | 通过，Vitest 10 文件 71 测试，Playwright 4 测试 |
