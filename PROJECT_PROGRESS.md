...
| 模拟支付 `/pay` | 满足 | 正确支付码才会记录支付事件并激活订阅；错误支付码不落库；重复事件幂等、跨 Session 冲突拒绝 |
...
| 测试与质量 | 已完成 | `npm test` 本地通过：Vitest 75 个测试、Playwright 4 条 E2E |
...
| 2026-09-22 | 一键测试 | `npm test` | 通过，Vitest 10 文件 75 测试，Playwright 4 测试 |
